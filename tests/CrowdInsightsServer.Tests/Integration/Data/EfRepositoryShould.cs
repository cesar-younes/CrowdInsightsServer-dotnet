...
namespace CrowdInsightsServer.Tests.Integration.Data
{
    public class EfRepositoryShould
    {
        ...
        private static DbContextOptions<AppDbContext> CreateNewContextOptions()
        {
            ...
            builder.UseInMemoryDatabase("crowdinsightsserver")
        ...
        private EfRepository<LogItem> GetRepository()
        {
            var options = CreateNewContextOptions();
            var mockDispatcher = new Mock<IDomainEventDispatcher>();

            _dbContext = new AppDbContext(options, mockDispatcher.Object);
            return new EfRepository<LogItem>(_dbContext);
        }
    }
}
